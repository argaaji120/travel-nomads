    ...
    <div class="section-popular-travel row justify-content-center">
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card-travel text-center d-flex flex-column"
          style="background-image: url('{{ asset('assets/frontend/images/travel-1.jpg') }}');">
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card-travel text-center d-flex flex-column"
          style="background-image: url('{{ asset('assets/frontend/images/travel-2.jpg') }}');">
          <div class="travel-country">INDONESIA</div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card-travel text-center d-flex flex-column"
          style="background-image: url('{{ asset('assets/frontend/images/travel-3.jpg') }}');">
          <div class="travel-country">INDONESIA</div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card-travel text-center d-flex flex-column"
          style="background-image: url('{{ asset('assets/frontend/images/travel-4.jpg') }}');">
          <div class="travel-country">INDONESIA</div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8 text-center">
        <img src="{{ asset('assets/frontend/images/partner.png') }}" class="img-patner" />
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="section-popular-travel row justify-content-center match-height">
      <div class="col-sm-6 col-md-6 col-lg-4">
        <div class="card card-testimonial text-center">
          <div class="testimonial-content">
            <img src="{{ asset('assets/frontend/images/avatar-1.png') }}" alt="" class="mb-4 rounded-circle" />
      ...
      <div class="col-sm-6 col-md-6 col-lg-4">
        <div class="card card-testimonial text-center">
          <div class="testimonial-content">
            <img src="{{ asset('assets/frontend/images/avatar-2.png') }}" alt="" class="mb-4 rounded-circle" />
      ...
      <div class="col-sm-6 col-md-6 col-lg-4">
        <div class="card card-testimonial text-center">
          <div class="testimonial-content mb-auto">
            <img src="{{ asset('assets/frontend/images/avatar-3.png') }}" alt="" class="mb-4 rounded-circle" />
